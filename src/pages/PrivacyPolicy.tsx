    ...
    <div className="w-full">
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="prose prose-slate max-w-none prose-headings:text-brand-navy prose-a:text-brand-accent hover:prose-a:text-brand-accent-hover">
            ...
            <p>
              <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@ccmsupremeremovals.com">info@ccmsupremeremovals.com</a>.
            </p>
            ...
            <ol>
              ...
              <li><a href="#clausea">CHANGES TO THIS PRIVACY POLICY</a></li>
            ...
            <ul>
              ...
              <li>address</li>
              <li>details regarding your moving requirements</li>
            </ul>
            ...
            <p>Our servers are located in the United Kingdom and United States. Regardless of your location, please be aware that your information may be transferred to, stored by, and processed by us in our facilities and in the facilities of the third parties with whom we may share your personal information (see 'WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?' above), including facilities in the United Kingdom, United States, and other countries.</p>
            ...
            <p>We do not knowingly collect, solicit data from, or market to children under 18 years of age, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at <a href="mailto:info@ccmsupremeremovals.com">info@ccmsupremeremovals.com</a>.</p>

            <h2 id="privacyrights">10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
            <p><strong><em>In Short:</em></strong><em> In some regions, such as the European Economic Area (EEA), United Kingdom (UK), and Switzerland, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time, depending on your country, province, or state of residence.</em></p>
            ...
            <p><strong><u>Withdrawing your consent:</u></strong> If we are relying on your consent to process your personal information, you have the right to withdraw your consent at any time. You can withdraw your consent at any time by contacting us by using the contact details provided in the section 'HOW CAN YOU CONTACT US ABOUT THIS NOTICE?' below.</p>
            ...
            <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:info@ccmsupremeremovals.com">info@ccmsupremeremovals.com</a>.</p>
            ...
            <h2 id="clausea">12. CHANGES TO THIS PRIVACY POLICY</h2>
            <p>We may update this Privacy Policy from time to time. Any changes will be posted on this page and reflected by an updated "Last Updated" date. We encourage users to review this policy periodically.</p>
            ...
            <p>If you have questions or comments about this notice, you may email us at <a href="mailto:info@ccmsupremeremovals.com">info@ccmsupremeremovals.com</a> or contact us by post at:</p>
            <p>
              CCM Supreme Removals Ltd<br />
              Luton, Bedfordshire LU15HR<br />
              England
            </p>
