            ...
            >
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:info@ccmsupremeremovals.com"
                      className="text-slate-600 hover:text-brand-accent font-medium transition-colors"
                    >
                      info@ccmsupremeremovals.com
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-12 pt-8 border-t border-slate-200">
                ...
                <div className="flex gap-4">
                  <a
                    href="https://www.facebook.com/profile.php?id=100076414621047"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-brand-navy hover:bg-brand-accent hover:text-white transition-colors shadow-sm"
                  >
                    <Facebook size={20} />
                  </a>
                  <a
                    href="https://www.instagram.com/george_ccm_supreme_removal/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-brand-navy hover:bg-brand-accent hover:text-white transition-colors shadow-sm"
                  >
                  ...
                  <a
                    href="https://www.tiktok.com/@ccmsupremeremovals"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-brand-navy hover:bg-brand-accent hover:text-white transition-colors shadow-sm"
                  >
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-accent focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <textarea
                    id="message"
                    rows={4}
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-accent focus:border-transparent transition-all resize-none"
